# VA HOME v14.0.0 RC3 — фінальний технічний аудит

## Статус релізу

`v14.0.0 RC3 · ATMOSPHERE OS` побудовано на перевіреній базі v13.8.36 із галереєю v13.8.17. Це функціонально завершений Release Candidate, а не позначений наперед STABLE-реліз.
