# VA HOME v14.0.0 RC6.1 — фінальний технічний аудит
...
- 26 матеріалів VA HOME Journal у правильному редакційному порядку; початкові 01–21 збережено без змін.
...
- Нові фото відгуків перед відправленням конвертуються у WebP, зменшуються до ширини 1600 px і завантажуються з MIME `image/webp`.
