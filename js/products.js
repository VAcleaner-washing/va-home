...
const PRODUCT_CONTENT_VERSION = "15.5.0-RC1.20";
...
const PRODUCTS = [
  {
    ...
    "formulaIntent": "Цитрусова ясність відкриває простір для білого чаю, імбиру та м’якого жасминового сліду, створюючи спокійну шовкову ауру.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Темна вишня, слива й троянда переходять у теплу пряну глибину кориці та бобів тонка, залишаючи соковитий вечірній слід.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Груша й яблуко переходять у вершково-праліневе серце з фіалкою та жимолостю, створюючи теплу й делікатно солодку атмосферу.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Ожина, лавр і грейпфрут поєднуються із сухим кедром та ветивером у свіжу ягідно-зелену композицію з чітким деревним контуром.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Юзу й світлі квіти розкривають чисту повітряну композицію, яку сандал і чорний перець огортають м’яким теплом.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Повітряні білі квіти поступово переходять у кашемірово-амброву глибину, створюючи спокійну атмосферу вечірнього простору.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Кокосове молоко, сандал і бензоїн утворюють оксамитову текстуру, доповнену теплом кедра та бобів тонка.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Білий чай, лотос і сухий сандал формують тиху композицію, а цитрус, кардамон і коріандр додають їй живої зеленуватої прохолоди.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Льон, озонічне повітря та мінеральна свіжість поєднуються з фрезією, сандалом і мохом у теплу атмосферу доглянутого готельного простору.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Перець і бергамот задають чіткий напрям, а лаванда, кедр, ветивер і лабданум формують сухий, зібраний деревно-пряний характер.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Морська сіль, шавлія та грейпфрут розкривають об’ємну мінеральну свіжість із м’яким тілесним теплом сучасного SPA.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Цитрусова прозорість переходить у легке квітково-деревне звучання, наповнюючи простір чистим світлом і майже невагомим об’ємом.",
    "insights": {
  ...
  },
  {
    ...
    "formulaIntent": "Копал, прохолодна камфора й сухий кедр формують інтелектуальну деревно-смолисту композицію з тактильною глибиною.",
    "insights": {
