const VERSION = '1.0.0-15.5.0-RC1.15';
...
const SHELL_ASSETS = [
  ...
  '/css/core-admin.css?v=15.5.0-RC1.15',
  '/css/site-admin.css?v=15.5.0-RC1.15',
  '/css/admin-mobile-system.css?v=15.5.0-RC1.15',
  '/js/config.js?v=15.5.0-RC1.15',
  '/js/products.js?v=15.5.0-RC1.15',
  '/js/admin.js?v=15.5.0-RC1.15',
  '/js/motion.js?v=15.5.0-RC1.15',
  '/admin/pwa.js?v=15.5.0-RC1.15'
];
