const VERSION = '1.0.0-15.5.0-RC1';
...
const SHELL_ASSETS = [
  ...
  '/css/core-admin.css?v=15.5.0-RC1',
  '/css/site-admin.css?v=15.5.0-RC1',
  '/js/config.js?v=15.5.0-RC1',
  '/js/products.js?v=15.5.0-RC1',
  '/js/admin.js?v=15.5.0-RC1',
  '/js/motion.js?v=15.5.0-RC1',
  '/admin/pwa.js?v=15.5.0-RC1'
];
