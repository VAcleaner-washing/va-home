...
## 13.8.18 — Stable Product Gallery Crossfade

- Перероблено зміну фото в картці аромату на стабільний двошаровий crossfade.
- Наступне фото повністю декодується у прихованому шарі до початку переходу.
- Прибрано zoom/scale-анімацію під час зміни кадру, яка могла давати короткий блік.
- Видиме фото більше не отримує новий `src` під час переходу.
- На touch-пристроях Apple прибрано нестабільний CSS mask після pinch zoom і замінено його м’яким статичним edge overlay.
- Версії клієнтського та Admin PWA кешу синхронізовано до 13.8.18.
